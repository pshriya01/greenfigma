...
import image from "../image/cropped-PETERS_Surgical_LOGO_CMJN-300x109@3x 1.svg";

const Sidebar = () => {
  return (
    <div style={{ position: "fixed", width: "249px",backgroundColor:"#181818" }}>
      <div style={{ padding: "15px" }}>
        <div style={{ padding: "13px 10px 13px 20px" }}>
          <img style={{ textAlign: "left" }} src={image} />
        </div>
      </div>
      <div
        style={{
      ...
      <div style={{ width: "100%", padding: "63.5px 31px 63.5px 7px" }}>
        ...
        >Open Help Centre</button>
      </div>
      {/* <div style={{height:"1306px"}}></div> */}
      <div style={{height:"48px", padding:"8px 0px",display: "flex",
height: "48px",
justifyContent: "center",
alignItems: "center",
gap: "8px",backgroundColor:"#02AB6C",color:"#FAFBFC"}}>
    <div>Powered by</div>
    <div>
